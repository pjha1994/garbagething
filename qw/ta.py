...
def read_reddit_images(change_file_number,m,x):
    ...
    maximum_number_of_next_pages=500
    parse1(s)
    count=0
...
def list_subreddits():
   ...
   b=[]
   b=['advice','academicpsychology','academicpublishing','accounting','Web_Development','WhatsTheWord','TrueReddit','Unix','TinyCode','TechNews','STEMdents',
      'ProgrammerHumor','Proofreading','Python','PhilosophyofScience','PhsychologicalTricks','PoliticalDiscussion','Neuropsychology','NoStupidQuestions','MathHelp',
      'Meditation','LifeProTips','LinguisticsHumor','HomeworkHelp','HowsYourJob','Foodforthought','FoundWords','Freethought','GetMotivated','GetStudying','ECE',
      'Economics','EngineeringStudents','CrazyIdeas','DIY','DIYCompSci','DailyProgrammer','Cplusplus','CppForbeginners','ComputerScience','Confession',
      'AskSocialScience','AskWomen','Ask_Politics','Bash','BehavioralEconomics','AskPhysics','AskReddit','AskScienceDiscussion','AskHistorians','AskAnthropology',
      'AskComputerScience','AskElectronics','AskEngineers','AcademicPhilosophy','AcademicPsychology','AskComputerScience','AskElectronics','AskEngineers',
      'AskHistorians','TrueAskReddit','IOPsychology','InternetIsBeautiful','LearnJava','LearnJavaScript','AskPhysics',
      'AskReddit','C_Programming','Cplusplus','CppForbeginners','HomeworkHelp','MathHelp','Python','answers','asklinguistics','askmath','askscience','changemyview',
      'coding','compsci','cpp','cpp_questions','india','java','javacodegeeks','javahelp','learnjava','learnmath','learnprogramming','learnpython','math','news',
      'philosophy','physics','programming','science','worldnews']#basic_short_interval
   b=[]
